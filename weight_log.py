...
dataset.procedure = "For consistency all measurements were made immediately after waking and using the restroom and prior to consuming any food or drink.  No clothin was worn while taking measurements."
dataset.creator = "Stephan Zednik <zednis@rpi.edu>"
dataset.source = "Stephan Zednik <zednis@rpi.edu>"
dataset.subject = "Stephan Zednik"
dataset.generated_by = "weight_log.py"
